...
$selectSql2 = "SELECT custos FROM venda WHERE cod_veiculo = ?";
...
$custoATUAL = floatval($custoAtual2['custos']);


$custoFINAL = $custoATUAL - $valor;


$stmt2 = $con->prepare("UPDATE venda SET custos = ? WHERE cod_veiculo = ?");
