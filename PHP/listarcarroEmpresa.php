...
$stmt = $con->prepare("
    ...
    GROUP BY v.id_veiculo, i.caminho_imagem, f.data_final, 
             cg.id_custos_garantia, cg.data_custo, cg.custos, cg.quantidade, cg.descricao_custo
");
...
while ($row = $result->fetch_assoc()) {
    ...
    unset(
        $carros[$id]['caminho_imagem'],
        $carros[$id]['id_custos_garantia'],
